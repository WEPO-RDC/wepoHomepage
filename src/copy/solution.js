const solutionCopy = [
    ...
    },
    {
        ...
        img:"https://github.com/WEPO-RDC/hpImage/raw/main/detailD.png",
        content: "N'importe quand nous vous tenons au courant quand quelqu'un vend votre produit preferés."
    },
    {
        title: "Finis les 'écris-moi en PV', même pour les PRIX ",
        img:"https://github.com/WEPO-RDC/hpImage/raw/main/PrixD.png",
        content:"Vous avez accès à toutes les informations sur le produit: nombre de rayures, niveau de la batterie, état de l'écran, capacité de stockage et même le PRIX (discutable ou pas).",
    },
    {
...
const futureService = [
    {
        ...
        content: "Nous allons bientôt offrir des livraisons securisées dans la ville de Kinshasa."
    }
]
